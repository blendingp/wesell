			...
			<form id="email-form-2" name="email-form-2" data-name="Email Form 2" method="get" class="form-16">
							...
							<div class="slide w-slide">
								<div class="banner_box">
									<div data-w-id="a7d60f71-f6aa-37b6-ae7d-ee2d3535c7a2" class="bannertxtwrap">
										...
										<a href="/global/trade.do?betMode=usdt" class="main_b_btn web w-button"><spring:message code="main.start_trading"/></a>
										...
										<a href="/global/trade.do?betMode=usdt" class="main_b_btn mobile w-button"><spring:message code="main.start_trading"/></a>
									</div>
								</div>
							</div>
						...
						<div class="m_b_item_warp">
							<div class="m_b_item">
								<div class="m_b_item_t">
									...
									<a href="/global/trade.do?betMode=usdt" class="m_b_link"><spring:message code="main.btxt1go"/></a>
								</div>
								<img src="/global/webflow/images/main-icon2.png" loading="lazy" alt="" class="m_b_item_img">
							</div>
							<div class="m_b_item">
								<div class="m_b_item_t">
									<div class="m_b_item_title"><spring:message code="main.btxt2"/></div>
									<a href="/global/user/myasset.do" class="m_b_link"><spring:message code="main.btxt2go"/></a>
								</div>
								<img src="/global/webflow/images/main-icon6.png" loading="lazy" alt="" class="m_b_item_img">
							</div>
							<div class="m_b_item">
								<div class="m_b_item_t">
									<div class="m_b_item_title"><spring:message code="main.btxt3"/></div>
									<a href="/global/user/p2pbuy.do" class="m_b_link"><spring:message code="main.btxt3go"/></a>
								</div>
								<img src="/global/webflow/images/main-icon8.png" loading="lazy" alt=""
									class="m_b_item_img">
							</div>
							<div class="m_b_item _2">
								<div class="m_b_item_t">
									<div class="m_b_item_title"><spring:message code="main.btxt4"/></div>
									<a href="/global/customerService.do" class="m_b_link"><spring:message code="main.btxt4go"/></a>
								</div>
								<img src="/global/webflow/images/main-icon4.png" loading="lazy" alt="" class="m_b_item_img">
							</div>
						</div>
					</div>
				...
				<div class="main_warp">
						...
						<div data-w-id="a7d60f71-f6aa-37b6-ae7d-ee2d3535c7fc" class="main_listarea">
							...
							<div class="main_list maincoin0  _2">
								<div class="main_coinsub">
									<img src="/global/webflow/images/BTCicon_img_1.png" loading="lazy" alt="" class="image-36">
							...
							<div class="main_list maincoin2  _2">
								<div class="main_coinsub">
									<img src="/global/webflow/images/XRPicon45.svg" loading="lazy" alt="" class="image-36">
							...
							<div class="main_list_b">
                				<a href="/global/trade.do" class="link-5"><spring:message code="main.viewmore"/><span class="main_list_arrow">▶</span></a>
              				</div>
						</div>
					</div>
					<div data-w-id="a7d60f71-f6aa-37b6-ae7d-ee2d3535c8a9" style="opacity: 0" class="main_section _3">
						...
						<div class="main_box1">
			            	<div class="slide_warp"><img src="/global/webflow/images/maingrp-1.svg" loading="lazy" alt="" class="operations_icon-2">
				                <h4 class="m_item2_title"><spring:message code="main.topper"/></h4>
				                <h5 class="heading-6"><spring:message code="main.text_2"/></h5>
			              	</div>
			              	<div class="slide_warp"><img src="/global/webflow/images/maingrp-2.svg" loading="lazy" alt="" class="operations_icon-2 _2">
			                	<h4 class="m_item2_title"><spring:message code="main.use"/></h4>
			                	<h5 class="heading-6"><spring:message code="main.use_t"/></h5>
			              	</div>
			              	<div class="slide_warp"><img src="/global/webflow/images/maingrp-3.svg" loading="lazy" alt="" class="operations_icon-2">
					...
					<div data-w-id="a7d60f71-f6aa-37b6-ae7d-ee2d3535c8cd" style="opacity:0" class="main_section _4">
            			...
            			<div class="main_imgbanner">
              				<div id="w-node-e8186ad0-50bf-cf3c-71f6-11edd22d4f7e-ecbe683f" class="main_img_b_box">
                				<div class="main_img_circle"><img src="/global/webflow/images/main-icon5.png" loading="lazy" alt="" class="main_img_b_img"></div>
              				...
              				<div id="w-node-_499abc9d-b1a7-e3d8-52c1-9c2044c2a729-ecbe683f" class="main_img_b_box">
				                <div class="main_img_circle"><img src="/global/webflow/images/main-icon1.png" loading="lazy" alt="" class="main_img_b_img"></div>
			              	...
			              	<div id="w-node-_822afc73-e203-3d7d-43db-561cd7d10c90-ecbe683f" class="main_img_b_box">
			              		<div class="main_img_circle"><img src="/global/webflow/images/main-icon7.png" loading="lazy" alt="" class="main_img_b_img"></div>
			              	...
			              	<div id="w-node-_0c66bbb6-8d68-25d7-3f9b-c6ead5b31ab5-ecbe683f" class="main_img_b_box">
				                <div class="main_img_circle"><img src="/global/webflow/images/main-icon3.png" loading="lazy" alt="" class="main_img_b_img"></div>
			              	...
			              	<div id="w-node-_1e394669-6728-ddbf-6bfb-91316b3ba1fc-ecbe683f" class="main_img_b_box">
				                <div class="main_img_circle"><img src="/global/webflow/images/main-icon9.png" loading="lazy" alt="" class="main_img_b_img"></div>
		              		...
		              		<div id="w-node-_4db1c82b-d2fe-fcdc-4372-351221417693-ecbe683f" class="main_img_b_box">
				                <div class="main_img_circle"><img src="/global/webflow/images/main-icon10.png" loading="lazy" alt="" class="main_img_b_img"></div>
		              		...
		              		<div id="w-node-_853368e3-d3d9-0017-7488-049f358d481c-ecbe683f" class="main_img_b_box">
				                <div class="main_img_circle"><img src="/global/webflow/images/main-icon11.png" loading="lazy" alt="" class="main_img_b_img"></div>
		              		...
		              		<div id="w-node-e7950f67-6be1-1021-f516-8f0de113e54e-ecbe683f" class="main_img_b_box">
				                <div class="main_img_circle"><img src="/global/webflow/images/main-icon12.png" loading="lazy" alt="" class="main_img_b_img"></div>
		            ...
		            <div class="m_store">
		              <div class="store_box">
		                ...
		                <div class="store_btnarea">
		                  <a href="https://play.google.com/store/apps/details?id=com.app.bitocean" target="_blank" class="appstore_btn w-inline-block"><img src="/global/webflow/images/white_googleplay.svg" loading="lazy" alt="" class="store_icon">
		                    <div>GET IT ON<br><span class="app_title">Google Play</span></div>
		                  </a>
		                  <a href="javascript:alert('<spring:message code="main.preparing"/>');" class="appstore_btn w-inline-block"><img src="/global/webflow/images/appstore_white.svg" loading="lazy" alt="" class="store_icon">
		                    <div>Download on the<br><span class="app_title">App Store</span></div>
		                  </a>
		                </div>
		              </div><img src="/global/webflow/images/main_dlogo-.png" loading="lazy" srcset="/global/webflow/images/main_dlogo--p-500.png 500w, /global/webflow/images/main_dlogo--p-800.png 800w, /global/webflow/images/main_dlogo--p-1080.png 1080w, /global/webflow/images/main_dlogo-.png 1208w" sizes="(max-width: 767px) 70vw, 500px" alt="" class="store_img">
		            </div>
		          </div>
				</div>
			</form>
