	...
	<div class="frame">
		...
		<div class="general_section wf-section">
			...
			<div class="general_block">
				<div class="deco"></div>
				<h1 class="general_title">테더(USDT) 판매</h1>
					...
					<div class="list_block">
						...
						<c:forEach var="item" items="${p2pList}">
							...
							<div class="list_warp">
								...
								<div class="list _2">
									<a href="javascript:p2pPop(${item.idx})" class="p2p_btn w-button">즉시 판매</a>
								</div>
							</div>
						</c:forEach>
					</div>
				...
				<form action="/global/easy/p2psell.do" name="listform" id="listform">
					...
					<div class="p_box2">
						<div class="form-block w-form">
							<form id="email-form" name="email-form" data-name="Email Form"
								...
								<h4 class="p_p_title">얼마나 판매하시겠습니까?</h4>
								<div class="div-block">
									<div class="p_p_warp">
						...
						<a href="javascript:submit()" class="p_btn w-button">즉시 판매</a>
	...
	<script>
		...
		function submit(){
			...
			jQuery.ajax({
				type : "POST",
				data : allData,
				url : "/global/easy/withdrawProcessP2P.do",
				dataType : "json",
