...
<body>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<div class="row">
							   <form action="/wesell/admin/user/walletList.do" name="listForm" id="listForm">
								...
								<tbody>
									<c:forEach var="item" items="${list}" varStatus="i">
										<tr style="background-color:${item.color}">
											<td>00${item.idx}&nbsp;</td>
											<td onclick="location.href='/wesell/admin/user/userDetail.do?idx=${item.idx}'" style="cursor:pointer;">${item.name}&nbsp;
	...
	function updateInfo(idx, kind){
		...
		$.ajax({
			type :'post',
			data : data,
			url : '/wesell/admin/user/updateInfo.do',
