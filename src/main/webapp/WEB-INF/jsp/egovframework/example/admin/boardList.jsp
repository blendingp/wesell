		...
		<div id="content-wrapper">
			<div id="content">
				...
				<div class="container-fluid">
										...
										<c:forEach var="item" items="${list}" varStatus="i">
											<tr>
												<td><input type="checkbox" name="arrayIdx"
													value="${item.bidx}" /></td>
												<td
													onclick="location.href='/global/0nI0lMy6jAzAFRVe0DqLOw/board/${type}Detail.do?idx=${item.bidx}'"
					...
					<form action="/global/0nI0lMy6jAzAFRVe0DqLOw/board/${type}List.do"
						name="listForm" id="listForm">
						<input type="hidden" name="pageIndex" value="1" /> <input
							type="hidden" name="type" value="${type}" />
					</form>
					<button type="button"
						onclick="location.href='/global/0nI0lMy6jAzAFRVe0DqLOw/board/${type}Write.do'"
	...
	function listDel(type) {
		...
		if (confirm("삭제하시겠습니까? 복구하실 수 없습니다.")) {
			jQuery.ajax({
				type : 'post',
				data : param,
				url : "/global/0nI0lMy6jAzAFRVe0DqLOw/board/" + type
						+ "Delete.do",
