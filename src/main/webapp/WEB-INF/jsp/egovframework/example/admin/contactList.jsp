			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form action="/global/0nI0lMy6jAzAFRVe0DqLOw/contact/contactList.do" name="listForm" id="listForm">
								<div class="col-lg-3">
									<label>검색</label>
								...
								<table class="table table-striped table-hover">
									...
									<tbody>
										<c:forEach var="item" items="${list}" varStatus="i">
											<tr class="check tr"
												onclick="location.href='/global/0nI0lMy6jAzAFRVe0DqLOw/contact/contactDetail.do?idx=${item.idx}'"
												...
												<td class="check box" style="display: none;"><input
													...
													value="${item.idx}"></td>
												<td
													onclick="location.href='/global/0nI0lMy6jAzAFRVe0DqLOw/user/userDetail.do?idx=${item.uidx}'">${item.mname}
...
function deleteSubmit(){
	...
	location.href="/global/0nI0lMy6jAzAFRVe0DqLOw/contact/contactDelete.do?idxs="+checkedVal;
}
function allSelect(){
	$("input:checkbox[name=is_check]").each(function() {
		 this.checked = true;
...
function confirm(idx){
	...
	$.ajax({
		type:'post',
		data:{"idx" : idx},
		url:'/global/0nI0lMy6jAzAFRVe0DqLOw/contact/contactConfirm.do?',
