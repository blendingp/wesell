			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">						
						<div class="card-body">
							<form action="/global/0nI0lMy6jAzAFRVe0DqLOw/trader/followerList.do" name="listForm" id="listForm">
								<div class="row">
									...
									<tbody>
										<c:forEach var="item" items="${list}" varStatus="i">
											<tr style="background-color:${item.color}">
												<td>${item.uidx}</td>
												<td onclick="location.href='/global/0nI0lMy6jAzAFRVe0DqLOw/user/userDetail.do?idx=${item.uidx}'" style="cursor: pointer;">${item.uname}</td>
												<td onclick="location.href='/global/0nI0lMy6jAzAFRVe0DqLOw/user/userDetail.do?idx=${item.tidx}'" style="cursor: pointer;">${item.tname}</td>
												<td>${item.symbol}</td>
