		                ...
		                <div class="card shadow mb-4">
				             <div class="card-header py-3">
		                        <h6 class="m-0 font-weight-bold text-primary">
			                    	<b>※ 동일 종목에 대해 조작이 진행 중일 때 중복 실행이 불가능합니다.</b>  <input type="button" value="새로고침" onclick="location.href='/wesell/admin/trade/manipulation.do'">
		...
		function setM(coin){
		    ...
		    if (confirm(msg)!=0) {
				...
				$.ajax({
					type :'post',
					data : data,
					url : '/wesell/admin/trade/manipulProcess.do',
