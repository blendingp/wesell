					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<form
										action="/wesell/admin/trade/kWithdrawalList.do"
...
function depositCancel(idx , midx){
	if(confirm("입금취소하시겠습니까?")){
		$.ajax({
			type :'get',
			url : '/wesell/admin/trade/cancelDeposit.do?idx='+idx+'&midx='+midx,
...
function checkRequest(widx,stat){
    ...
    jQuery.ajax({                                
        type:"POST", 
        url : "/wesell/admin/trade/kWithdrawalProcess.do?widx="+widx+"&stat="+stat,
        dataType:"json",
